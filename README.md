...
Air pollution levels can be difficult to interpret directly from raw particulate matter readings, so this system simplifies the process by converting pollutant concentrations into:
An understandable AQI score (0–500)
...
2)uses linear interpolation (EPA FORMULA)
